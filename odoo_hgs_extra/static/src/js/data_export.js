(function() {
	...
	instance.web.View.include({
		on_sidebar_export: function() {
	        alert("hello");
	        new instance.odoo_hgs_extra.HgsDataExport(this, this.dataset).open();
	    },
	});

	instance.odoo_hgs_extra.HgsDataExport = instance.web.Dialog.extend({
	    template: 'HgsExportTreeView',
	    dialog_title: {toString: function () { return _t("数据导出"); }},
	    events: {
	        ...
	        'click #save_new_fields_list': 'on_show_save_list',
	    },
	    init: function(parent, dataset) {
	        var self = this;
	        var options = {
	            buttons: [
	                {text: _t("关闭"), click: function () { self.$el.parents('.modal').modal('hide'); }},
	                {text: _t("数据导出"), click: function () { self.on_click_export_data(); }},
	            ],
	    ...
	    start: function() {
	        ...
	        self.$el.find('#fields-tree-structure').remove();
	        ...
	        return $.when(
	            got_fields,
	            got_domain,
	            this.rpc('/hgs/export/formats', {}).done(this.do_setup_export_formats),
	    ...
	    on_click_export_data: function() {
	        ...
	        exported_fields.unshift({name: 'id', label: 'ID'});
	        ...
	        this.session.get_file({
	            url: '/hgs/extra/export/' + export_format,
